...
export default function Certifications({ onOpenModal }) {
  const certsData = [
    ...
    },
    {
      ...
      issuer: 'EduSkills',
      date: '2026',
      pdf: './assets/certifications/Java_Full_Stack_Development.pdf',
      drive: 'https://drive.google.com/file/d/1zY_-r06bET0rj3ULVSVT1t2rLSscqkce/view',
    },
    {
    ...
    },
    {
      ...
      issuer: 'AWS',
      date: '2025',
      pdf: './assets/certifications/AWS_DATA.pdf',
      drive: 'https://drive.google.com/file/d/1dDjorvwQP12kMoZnmY_aQlEHPzlr_YDT/view',
    },
    {
      title: 'Cloud Virtual Internship',
      issuer: 'AWS',
      date: '2025',
      pdf: './assets/certifications/ACLOUD_VIRTUAL.pdf',
